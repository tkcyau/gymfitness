    ...
    <?php while(have_posts()): the_post(); ?>
        ...
        <section class="instructors">
            <div class="container section">
                ...
                <p class="text-center">Professional instructors that will help you achieve your fitness goals</p>
        ...
        <section class="blog container section">
            ...
            <p class="text-center">Check out our blog posts for some tips on your workouts</p>
